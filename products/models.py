...
class BaseModel(models.Model):
    ...
    created_st = models.DateField(auto_created=True)
    update_st = models.DateField(auto_created=True)
    class Meta:
        abstract = True
...
class ProductImage(BaseModel):
    product = models.ForeignKey(Product ,on_delete=models.CASCADE , related_name = "meta_info")
